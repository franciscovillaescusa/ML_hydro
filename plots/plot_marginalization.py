...
k1, dA_NN1, dB_NN1, dA_LS1, dB_LS1 = np.loadtxt(f1,unpack=True)
...
f_out = 'NN_marginalization1_05.pdf'

p1,=ax1.plot(k1,dA_NN1,linestyle='-',marker='None', c='r')
p2,=ax1.plot(k1,dB_NN1,linestyle='-',marker='None', c='b')

p3,=ax1.plot(k2,dA_NN3,linestyle=':',marker='None', c='r')
p4,=ax1.plot(k2,dB_NN3,linestyle=':',marker='None', c='b')

#legend
ax1.legend([p1,p2,p3,p4],
           [r"$A:\,\,{\rm no\,baryons}$",
            r"$B:\,\,{\rm no\,baryons}$",
            r"$A:\,\,{\rm baryons\,at\,k=0.5~h{\rm Mpc}^{-1}}$",
            r"$B:\,\,{\rm baryons\,at\,k=0.5~h{\rm Mpc}^{-1}}$"],
           loc=0,prop={'size':13},ncol=1,frameon=True)
...
f_out = 'NN_marginalization2_05.pdf'

p1,=ax1.plot(k1,dA_NN1,linestyle='-',marker='None', c='r')
p2,=ax1.plot(k1,dB_NN1,linestyle='-',marker='None', c='b')

p3,=ax1.plot(k2,dA_NN2,linestyle='--',marker='None', c='r')
p4,=ax1.plot(k2,dB_NN2,linestyle='--',marker='None', c='b')
...
f_out = 'NN_marginalization_05.pdf'
...
p5,=ax1.plot(k2,dA_NN3,linestyle=':',marker='None', c='r')
p6,=ax1.plot(k2,dB_NN3,linestyle=':',marker='None', c='b')
...
ax1.legend([p1,p2,p3,p4,p5,p6],
           [r"$A:\,\,{\rm no\,baryons}$",
            ...
            r"$A:\,\,{\rm model\,2}$",
            r"$B:\,\,{\rm model\,2}$"],
           loc=0,prop={'size':11.7},ncol=3,frameon=True)
