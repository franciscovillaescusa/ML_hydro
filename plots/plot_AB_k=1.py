...
x_min, x_max = 0, 10.5
y_min, y_max = -1.05, 0.05

f_out='AB_values_k=1.pdf'

f1 = '../results/AB_values/AB_values_kmax=1.00.txt'
...
ax1.text(5.5,-0.8, 'Neural network', fontsize=17, color='w')
ax2.text(5.5,-0.8, 'Max likelihood', fontsize=17, color='w')
