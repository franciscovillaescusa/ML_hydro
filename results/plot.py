...
x_min, x_max = 0.01, 1.1
y_min, y_max = 1e-2, 1e3
...
f1 = 'results_kpivot=2.0_no-gamma.txt'
k,dA,dB = np.loadtxt(f1,unpack=True) 
p1,=ax1.plot(k,dA,linestyle='-',marker='None',c='b')
p2,=ax1.plot(k,dB,linestyle='-',marker='None',c='r')

f1 = 'results_kpivot=0.5_no-gamma.txt'
k,dA,dB = np.loadtxt(f1,unpack=True) 
ax1.plot(k,dA,linestyle='--',marker='None',c='b')
ax1.plot(k,dB,linestyle='--',marker='None',c='r')

f1 = 'results_kpivot=0.5_gamma.txt'
k,dA,dB,dC = np.loadtxt(f1,unpack=True) 
p3,=ax1.plot(k,dC,linestyle='-.',marker='None',c='g')
